      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Swap Skills. <span className="text-blue-600">Learn Together.</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Connect with passionate learners to exchange skills, share
            knowledge, and grow together. Whether you're teaching or learning,
            SkillSwap makes it easy to find the perfect match.
          </p>
